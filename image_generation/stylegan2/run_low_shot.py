...
from image_generation.stylegan2.training import dataset_tool
...
def main():
    ...
    parser.add_argument('--result-dir', help='Root directory for run results (default: %(default)s)', default='results',
                        metavar='DIR')
    parser.add_argument('--DiffAugment', help='Comma-separated list of DiffAugment policy',
    ...
    parser.add_argument('--metrics', help='Comma-separated list of metrics or "none" (default: %(default)s)',
                        default='fid5k-train', type=_parse_comma_sep)

...
def resize(cfg, img, grt=None, mode=ModelPhase.TRAIN):
    """
    改变图像及标签图像尺寸
...
def random_rotation(cfg, crop_img, crop_seg, rich_crop_max_rotation, mean_value):
    """
    随机旋转图像和标签图
    Args：
...
def rand_crop(cfg, crop_img, crop_seg, mode=ModelPhase.TRAIN):
    """
